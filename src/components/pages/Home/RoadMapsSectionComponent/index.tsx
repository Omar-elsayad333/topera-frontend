  ...
  return (
    <Stack sx={{ py: '64px' }} gap={'40px'}>
      ...
      <Typography variant="h5">
        ...
        This structured approach helps you stay focused and avoid distractions, ensuring steady progress. Whether you're
        learning a new programming language, developing a project, or preparing for a certification, our roadmaps
        provide clear guidance and milestones to help you achieve success efficiently. With our roadmaps, you'll always
        know the next step to take on your path to mastery.
      </Typography>
      <Button
        variant="contained"
        sx={{
